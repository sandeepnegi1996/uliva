...
const variantClasses: Record<BadgeVariant, string> = {
  ...
  new: "bg-[#f0c96b] text-[#153d30] dark:bg-[#f0c96b] dark:text-[#153d30] shimmer-badge",
  ...
  neutral: "bg-stone-100 text-stone-600 dark:bg-stone-700 dark:text-stone-300 glow-pulse",
};
